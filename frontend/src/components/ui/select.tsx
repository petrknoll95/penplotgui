  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <CaretDown className="size-4 opacity-50" weight="fill" />
    ...
    >
      ...
      >
        <SelectPrimitive.ItemIndicator>
          <Check className="size-4" weight="fill" />
        </SelectPrimitive.ItemIndicator>
      </span>
